...
const Game = ({ setGameStarted }) => {
  ...
  //// cartas
  const cartasAudioRef = useRef(null);
  // cartas
  useEffect(() => {
    cartasAudioRef.current = new Audio(cartasAudio);
    cartasAudioRef.current.loop = false;
    cartasAudioRef.current.volume = 1.0;
    return () => {
